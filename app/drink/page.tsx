    ...
    <div className="min-h-[100dvh] flex flex-col bg-brew pt-safe">
      ...
      <div className="px-5 pb-4">
        <input
          ...
          className="w-full rounded-2xl bg-card px-4 py-3.5 text-bark placeholder-muted border border-tan focus:outline-none focus:ring-2 focus:ring-amber text-base shadow-sm"
        />
      </div>
      ...
      {sheetVisible && selected && (
        <>
          ...
          {/* Sheet */}
          <div
            className={`fixed bottom-0 left-0 right-0 z-50 bg-brew rounded-t-3xl shadow-2xl pb-safe
